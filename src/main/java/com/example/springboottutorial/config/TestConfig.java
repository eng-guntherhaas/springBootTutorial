...
import com.example.springboottutorial.entities.enums.OrderStatus;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2022-08-22T20:23:12Z"), OrderStatus.WAITING_PAYMENT, u1);
        Order o2 = new Order(null, Instant.parse("2022-07-21T12:32:43Z"), OrderStatus.CANCELED, u2);
        Order o3 = new Order(null, Instant.parse("2022-07-21T16:52:22Z"), OrderStatus.PAID, u1);
